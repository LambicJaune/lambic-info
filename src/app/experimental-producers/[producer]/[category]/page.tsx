            ...
            <>
                ...
                <main className={styles.pageContainer}>
                    <div style={{ textAlign: "center", padding: "10rem 2rem", color: "white" }}>
                        ...
                        <Link href={`/experimental-producers/${producer}`} style={{ color: "#f1ca54", textDecoration: "underline" }}>
                ...
                <div className={styles.pageContent}>
                    <div className={styles.contentWrapper}>
                        ...
                        <div style={{ textAlign: "center", marginTop: "5rem", paddingBottom: "4rem" }}>
                            <Link href={`/experimental-producers/${producer}`} className={styles.centeredTitle} style={{ fontSize: "1.5rem", }}>
